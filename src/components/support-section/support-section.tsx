...
export const SupportSection = () => {
    return (
        <section className='pb-32 md:py-10 container'>
            <div className='flex flex-col items-center gap-12'>
                <h2 className={`${ptSansCaption.className} text-balance text-center text-heading-lg text-gray-100`}>
                ...
                <div className='grid gap-6 md:grid-cols-3'>
                    ...
                    <div className='flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-blue-400'>
                        ...
                        <strong className='text-heading-sm text-gray-100'>
                            Receba suporta amigável
                        </strong>
                        <p className='text-body-sm text-gray-200'>
                            Nossa equipe estará sempre pronta para te atender e para ajudar no que for preciso.
                        </p>
                    </div>
                </div>
